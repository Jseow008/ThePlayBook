...
export const WELCOME_PERSONALIZATION_TOUR_KEY = "welcome-personalization";
export const WELCOME_PERSONALIZATION_VERSION = "v1";
...
export function readGuestOnboardingEntry(
...
export function createGuestOnboardingEntry(
  status: OnboardingStatus,
): OnboardingStateEntry {
  return {
    status,
