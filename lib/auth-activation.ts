...
import { APP_ONBOARDING_TOUR_KEY, APP_ONBOARDING_VERSION, hasSeenOnboardingVersion } from "@/lib/onboarding";
...
export async function resolvePostAuthDestination(
    ...
    const profile = data as unknown as Pick<ProfileRow, "onboarding_state"> | null;
    ...
    return hasCompletedActivation ? normalizedNext : buildWelcomePath(normalizedNext);
}
