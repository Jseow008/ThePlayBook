...
Status: In progress — cosine migration, regression proof, empty replay, production-snapshot benchmark, and disposable-hosted verification pass; production remains unchanged pending gated rollout
...
- [ ] The migration is deployed through the gated workflow and passes post-deployment parity, relevance, plan, advisor, and application smoke checks.
