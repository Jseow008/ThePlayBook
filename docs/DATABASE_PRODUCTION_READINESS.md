...
Status: In progress — recovery targets, independent Storage verification, a local restore drill, and production bucket controls are complete; paid-plan retention, PITR, and alerts remain
...
- **Retention:** retain at least 30 daily database and independent Storage recovery points plus 12 monthly recovery points. Keep the 2026-07-14, 2026-07-15, and 2026-07-16 pre-change backups until this automated policy has operated successfully for 30 days.
