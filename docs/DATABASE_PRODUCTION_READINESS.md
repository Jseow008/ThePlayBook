...
| DB-105 | P1       | Add core database constraints and invariants                             | In progress — hosted proof complete; production pending         | Yes             |
...
Status: In progress — production audit, local replay, and disposable hosted verification complete; production pending
