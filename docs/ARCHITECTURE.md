...
Netflux is a summary-first knowledge system for people who want to revisit, connect, and use ideas over time. Visitors can discover readable knowledge distilled from books, podcasts, articles, and videos without logging in. Authenticated users layer on cross-device state: saved items, reading progress, highlights, notes, reading history, and AI-powered retrieval across their library. Admin users manage publishing, series, homepage sections, media uploads, and embedding operations.
