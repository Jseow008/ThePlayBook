...
For Lifebook, UI UX Pro Max is a reference library, not the design authority.
...
- Master design system: `design-system/lifebook/MASTER.md`
- Landing page override: `design-system/lifebook/pages/landing.md`

These files are intended as assistant reference material during future UI work.

## Recommended Workflow For Lifebook
...
6. Treat `design-system/lifebook/MASTER.md` and page overrides as historical reference artifacts, not as source of truth.
...
Avoid this for normal Lifebook UI work. Use only for explicit redesign exploration.
...
The upstream skill tends to generate opinionated alternate design systems and generic landing-page patterns. In Lifebook, that can degrade usability by replacing an already coherent product hierarchy with a template-driven style direction.
