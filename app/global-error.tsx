...
export default function GlobalError({ error, reset }: ErrorProps) {
    useEffect(() => {
        ...
        Sentry.withScope((scope) => {
            scope.setTag("boundary", "global-error-boundary");
            scope.setContext("global_error_boundary", {
            ...
            <body className="min-h-screen bg-background text-foreground flex items-center justify-center p-6 font-sans antialiased">
                <div className="max-w-md w-full text-center space-y-6">
                    ...
                    <div className="space-y-2">
                        <h1 className="text-2xl font-bold tracking-tight">Something went wrong critically</h1>
                        <p className="text-muted-foreground text-sm leading-relaxed">
                            An unexpected system error occurred at the root layout. Try refreshing the page.
                        </p>
                        {error.digest && (
