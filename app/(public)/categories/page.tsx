            ...
            <div className="max-w-3xl mx-auto px-5 sm:px-6 py-8 sm:py-12">
                ...
                {categories.length > 0 ? (
                            ...
                            return (
                                <Link
                                    ...
                                    className={`
                                        ...
                                        bg-secondary/40 hover:bg-secondary/60 transition-colors duration-200
                                ...
                                >
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold text-foreground/80 group-hover:text-foreground transition-colors">
                                            {category.name}
                                        </h3>
                                    </div>
                                </Link>
                    ...
                    <div className="text-center py-20 animate-fade-in">
                        <div className="inline-flex items-center justify-center p-6 bg-secondary/30 rounded-full mb-6 border border-border relative overflow-hidden group">
